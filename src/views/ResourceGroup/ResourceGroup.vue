...
export default {
  ...
  methods: {
    ...
    async onSubmit () {
       ...
       console.log(res)
        ...
        this.displayData = (await resourcegroup(localStorage.username,localStorage.subscriptionId)).data;
      } else {
  ...
  async mounted() {
    this.tableData = (await resourcegroup(localStorage.username,localStorage.subscriptionId)).data.value;
